...
import type { PauseRestaurantCommand } from './pause-restaurant.command';

@Injectable()
export class PauseRestaurantUseCase {
    constructor(
    ...
    async execute(command: PauseRestaurantCommand): Promise<void> {
        ...
        await this.eventPublisher.publishAll([new RestaurantPausedEvent(restaurant.id.value)]);
    }
}
