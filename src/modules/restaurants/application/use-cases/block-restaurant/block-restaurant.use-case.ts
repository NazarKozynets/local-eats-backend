...
import type { BlockRestaurantCommand } from './block-restaurant.command';

@Injectable()
export class BlockRestaurantUseCase {
    constructor(
    ...
    async execute(command: BlockRestaurantCommand): Promise<void> {
        ...
        await this.eventPublisher.publishAll([new RestaurantBlockedEvent(restaurant.id.value)]);
    }
}
