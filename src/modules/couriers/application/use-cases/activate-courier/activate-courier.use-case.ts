...
import type { ActivateCourierCommand } from './activate-courier.command';

@Injectable()
export class ActivateCourierUseCase {
    constructor(
    ...
    async execute(command: ActivateCourierCommand): Promise<void> {
        ...
        await this.eventPublisher.publishAll([
            new CourierActivatedEvent(profile.id.value, userId.value),
        ]);
    }
}
