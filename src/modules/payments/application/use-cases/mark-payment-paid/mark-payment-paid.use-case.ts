...
import type { MarkPaymentPaidCommand } from './mark-payment-paid.command';
...
export class MarkPaymentPaidUseCase {
    ...
    async execute(command: MarkPaymentPaidCommand): Promise<void> {
        ...
        payment.markPaid(command.providerPaymentId ?? undefined, command.paidAt ?? undefined);
