...
import type { UpdateCustomerAddressCommand } from './update-customer-address.command';
...
export class UpdateCustomerAddressUseCase {
    ...
    async execute(command: UpdateCustomerAddressCommand): Promise<void> {
        ...
        await this.eventPublisher.publishAll([
            new CustomerAddressUpdatedEvent(address.id.value, profile.id.value),
        ]);
    }
}
